        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h1 class="text-white mb-4">We are here for you</h1>
                        <p class="text-white mb-0">We respect our customer's thought here you can share your experince or feedback with us.we can try to give our best.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control border-0" placeholder="Your Name"></textarea>
                                </div>
                                <div class="col-12">
                                    <textarea class="form-control border-0" placeholder="Your Email"></textarea>
                                </div>
