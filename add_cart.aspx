<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_cart.aspx.cs" Inherits="add_cart" %>
      ...
      <div class="col-md-8">
            ...
            <div class="row">
              <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                ...
                <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                    <img class="bg-light rounded-circle p-2 mx-auto mb-3" src="img/car seat 3.jpeg" style="width: 120px; height: 120px;">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <p class="mb-0">10.05.2023 - 12.05.2023</p>
          </div>
        </div>
